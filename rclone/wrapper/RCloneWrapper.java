...
public class RCloneWrapper {
	 ...
	 * parametro no metodo. A saida sera lida e atraves do parametro booleano será
	 * decidido se irá ser listado por token (utilizando Scanner.next) ou listando
	 * por linha (utilizando Scanner.nextLine)
	 *
	 * @param byToken Ler por token
	 * @param args    Parametros que será passado para o Rclone
	 * @return Lista com a saida do comando, sendo separado por linha ou por token.
	 * @throws IOException
	 */
