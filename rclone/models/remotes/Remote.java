...
/**
 * Classe que representa um remoto. Todos os comandos relacionado ao remoto, como
 * lista arquivos, copiar, mover ou melhor exemplificado: rclone * remote:, irá 
 * vir para aqui com exceção do delete. Esse metodo se encontra aqui como forma 
 * mais agil de realizar essa ação.
 * 
 * @author Nrold
 */
public class Remote {
	...
	/**
	 * Metodo para deletar o remoto.
	 * Esse metodo é o mesmo que RemoteType.delete(wrapper,remote);
	 */
	public void delete() {
